...
the Successor function nor the current inheritance order. You can treat it as just marking the person as dead.
...
public class ThroneInheritance {
    ...
    public static void main(String[] args) {
        ThroneInheritancePojo obj = new ThroneInheritancePojo("king");
        obj.birth("king", "andy");
        obj.birth("king", "bob");
...
class ThroneInheritancePojo {
    Map<String, List<String>> family;
    Set<String> dead;
    String root;
    public ThroneInheritancePojo(String kingName) {
        this.root = kingName;
        dead = new HashSet<>();
        family = new HashMap<>();
    ...
    private void dfs(String root, List<String> order){
