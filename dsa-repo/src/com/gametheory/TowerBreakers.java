...
In the first test case,  chooses one of the two towers and reduces it to . Then  reduces the remaining tower to
a height of . As both towers now have height ,  cannot make a move so  is the winner.

In the second test case, there is only one tower of height .  can reduce it to a height of either  or .  chooses
as both players always choose optimally. Because  has no possible move,  wins.
...
public class TowerBreakers {
    ...
    public static void main(String[] args) {
        System.out.println(new TowerBreakers().towerBreakers(1,4));
    }
