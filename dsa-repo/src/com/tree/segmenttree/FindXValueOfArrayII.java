...
public class FindXValueOfArrayII {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new FindXValueOfArrayII().resultArray(
                new int[]{1,2,3,4,5}, 3, new int[][]{{2,2,0,2}, {3,3,3,0},{0,1,0,1}}
        )));
    }
    public int[] resultArray(int[] nums, int k, int[][] queries) {
        int n = nums.length;
        SegmentTree1 seg = new SegmentTree1(nums, k);
...
class SegmentTree1 {
    ...
    public SegmentTree1(int[] nums, int k) {
        this.k = k;
        this.n = nums.length;
