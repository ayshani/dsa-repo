...
TC : o(m*m * n*n)
SC: o(m*n)
Ref : https://leetcode.com/problems/find-the-minimum-area-to-cover-all-ones-ii/editorial/?envType=daily-question&envId=2025-08-23

 */
public class FindTheMinimumAreaToCoverAllOnesII {

    public static void main(String[] args) {
        System.out.println(new FindTheMinimumAreaToCoverAllOnesII().minimumSum(
                new int[][]{
                        {1,0,1},{1,1,1}
                }
        ));
