...
form words by pushing them. For example, the key 2 is mapped with ["a","b","c"], we need to push the key one time to
...
public class MinimumNumberOfPushesToTypeWordI {
    ...
    public static void main(String[] args) {
        System.out.println(new MinimumNumberOfPushesToTypeWordI().minimumPushes("abcde"));
    }
