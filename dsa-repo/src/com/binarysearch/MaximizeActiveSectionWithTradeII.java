...
Time Complexity: O(n+qlogn), including the preprocessing part such as building the segment tree, with a time
complexity of O(n). For each query:

The time complexity of two binary searches is O(logn);

The time complexity of one segment tree range maximum query is O(logn).
...
public class MaximizeActiveSectionWithTradeII {
    ...
    public static void main(String[] args) {
        System.out.println(new MaximizeActiveSectionWithTradeII().maxActiveSectionsAfterTrade(
                "01", new int[][]{{0,1}}
        ));
    }
    public List<Integer> maxActiveSectionsAfterTrade(
        ...
        MaximizeActiveSectionWithTradeIISegmentTree seg = new MaximizeActiveSectionWithTradeIISegmentTree(tmpSum);
...
class MaximizeActiveSectionWithTradeIISegmentTree {
    ...
    public MaximizeActiveSectionWithTradeIISegmentTree(int[] arr) {
        this.arr = arr;
        this.n = arr.length;
