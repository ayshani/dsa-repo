...
the jth element. If i < j and both elements are smaller (or larger) than pivot, then pi < pj.
...
public class PartitionArrayAccordingToGivenPivot {
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new PartitionArrayAccordingToGivenPivot().pivotArray(
