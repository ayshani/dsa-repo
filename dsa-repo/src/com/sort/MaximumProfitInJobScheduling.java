...
public class MaximumProfitInJobScheduling {
    ...
    public static void main(String[] args) {
        int[] start = new int[]{1,2,3,3}, end = new int[]{3,4,5,6}, profit = new int[]{50,10,40,70};
        System.out.println(new MaximumProfitInJobScheduling().jobScheduling(start,end,profit));
    }
