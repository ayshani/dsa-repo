...
Example 1:Input: grid = [[3,4,5,1,3],[3,3,4,2,3],[20,30,200,40,10],[1,5,5,4,1],[4,3,2,2,5]]
Output: [228,216,211]
...
public class GetBiggestThreeRhombusSumsInAGrid {
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new GetBiggestThreeRhombusSumsInAGrid().getBiggestThree(
