...
Let’s say you are given a set = {1, 2, 3, 7} and a total = 6. The output will be 1 as the subset = {1, 2, 3}
...
public class CountOfSubsetSum {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new CountOfSubsetSum().subsetSum(nums,13));
    }
    public  int subsetSum (int [] nums, int total) {
        // Your code will replace the placeholder below
        int n = nums.length;
        Integer[][] dp =  new Integer[n+1][total+1];
        return util(nums, total,n,dp);
    }
